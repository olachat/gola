...
func FetchByPKCtx(ctx context.Context, val uint) (*GiftsWithDefault, error) {
	return coredb.FetchByPKCtx[GiftsWithDefault](ctx, DBName, TableName, []string{"id"}, val)
}
...
func FetchByPKsCtx(ctx context.Context, vals ...uint) ([]*GiftsWithDefault, error) {
	pks := coredb.GetAnySlice(vals)
	return coredb.FetchByPKsCtx[GiftsWithDefault](ctx, DBName, TableName, "id", pks)
}
...
func FindOneCtx(ctx context.Context, whereSQL string, params ...any) (*GiftsWithDefault, error) {
	w := coredb.NewWhere(whereSQL, params...)
	return coredb.FindOneCtx[GiftsWithDefault](ctx, DBName, TableName, w)
}
...
// whereSQL must start with "where ..."
func FindCtx(ctx context.Context, whereSQL string, params ...any) ([]*GiftsWithDefault, error) {
	w := coredb.NewWhere(whereSQL, params...)
	return coredb.FindCtx[GiftsWithDefault](ctx, DBName, TableName, w)
}
...
func CountCtx(ctx context.Context, whereSQL string, params ...any) (int, error) {
	return coredb.QueryIntCtx(ctx, DBName, "SELECT COUNT(*) FROM `gifts_with_default` "+whereSQL, params...)
}

// FetchByPK returns a row from `gifts_with_default` table with given primary key value
func FetchByPKFromMasterCtx(ctx context.Context, val uint) (*GiftsWithDefault, error) {
	return coredb.FetchByPKFromMasterCtx[GiftsWithDefault](ctx, DBName, TableName, []string{"id"}, val)
}
...
// FetchByPKs returns rows with from `gifts_with_default` table with given primary key values
func FetchByPKsFromMasterCtx(ctx context.Context, vals ...uint) ([]*GiftsWithDefault, error) {
	pks := coredb.GetAnySlice(vals)
	return coredb.FetchByPKsFromMasterCtx[GiftsWithDefault](ctx, DBName, TableName, "id", pks)
}
...
// FindOne returns a row from `gifts_with_default` table with arbitary where query
// whereSQL must start with "where ..."
func FindOneFromMasterCtx(ctx context.Context, whereSQL string, params ...any) (*GiftsWithDefault, error) {
	w := coredb.NewWhere(whereSQL, params...)
	return coredb.FindOneFromMasterCtx[GiftsWithDefault](ctx, DBName, TableName, w)
}
...
// Find returns rows from `gifts_with_default` table with arbitary where query
// whereSQL must start with "where ..."
func FindFromMasterCtx(ctx context.Context, whereSQL string, params ...any) ([]*GiftsWithDefault, error) {
	w := coredb.NewWhere(whereSQL, params...)
	return coredb.FindFromMasterCtx[GiftsWithDefault](ctx, DBName, TableName, w)
}
...
func CountFromMasterCtx(ctx context.Context, whereSQL string, params ...any) (int, error) {
	return coredb.QueryIntFromMasterCtx(ctx, DBName, "SELECT COUNT(*) FROM `gifts_with_default` "+whereSQL, params...)
}

// Insert GiftsWithDefault struct to `gifts_with_default` table
func (c *GiftsWithDefault) InsertCtx(ctx context.Context) error {
...
func (obj *GiftsWithDefault) UpdateCtx(ctx context.Context) (bool, error) {
