...
func FetchByPKCtx(ctx context.Context, val uint) *GiftsWithDefault {
...
func FetchByPKsCtx(ctx context.Context, vals ...uint) []*GiftsWithDefault {
...
func FindOneCtx(ctx context.Context, whereSQL string, params ...any) *GiftsWithDefault {
...
// FetchByPK returns a row from `gifts_with_default` table with given primary key value
func FetchByPKFromMasterCtx(ctx context.Context, val uint) *GiftsWithDefault {
...
// FetchByPKs returns rows with from `gifts_with_default` table with given primary key values
func FetchByPKsFromMasterCtx(ctx context.Context, vals ...uint) []*GiftsWithDefault {
	pks := coredb.GetAnySlice(vals)
...
// FindOne returns a row from `gifts_with_default` table with arbitary where query
// whereSQL must start with "where ..."
func FindOneFromMasterCtx(ctx context.Context, whereSQL string, params ...any) *GiftsWithDefault {
	w := coredb.NewWhere(whereSQL, params...)
