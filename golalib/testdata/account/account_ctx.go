...
func FetchByPKCtx(ctx context.Context, val PK) *Account {
...
func FindOneCtx(ctx context.Context, whereSQL string, params ...any) *Account {
...
// FetchByPK returns a row from `account` table with given primary key value
func FetchByPKFromMasterCtx(ctx context.Context, val PK) *Account {
...
// FindOne returns a row from `account` table with arbitary where query
// whereSQL must start with "where ..."
func FindOneFromMasterCtx(ctx context.Context, whereSQL string, params ...any) *Account {
	w := coredb.NewWhere(whereSQL, params...)
