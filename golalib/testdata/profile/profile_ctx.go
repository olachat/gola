...
func FetchByPKCtx(ctx context.Context, val int) *Profile {
...
func FetchByPKsCtx(ctx context.Context, vals ...int) []*Profile {
...
func FindOneCtx(ctx context.Context, whereSQL string, params ...any) *Profile {
...
// FetchByPK returns a row from `profile` table with given primary key value
func FetchByPKFromMasterCtx(ctx context.Context, val int) *Profile {
...
// FetchByPKs returns rows with from `profile` table with given primary key values
func FetchByPKsFromMasterCtx(ctx context.Context, vals ...int) []*Profile {
	pks := coredb.GetAnySlice(vals)
...
// FindOne returns a row from `profile` table with arbitary where query
// whereSQL must start with "where ..."
func FindOneFromMasterCtx(ctx context.Context, whereSQL string, params ...any) *Profile {
	w := coredb.NewWhere(whereSQL, params...)
