...
// InsertTx inserts Gift struct to `gifts` table with transaction
func (c *Gift) InsertTx(ctx context.Context, tx *sql.Tx) error {
...
// UpdateTx updates Gift struct in `gifts` table with transaction
func (obj *Gift) UpdateTx(ctx context.Context, tx *sql.Tx) (bool, error) {
...
// UpdateTx updates Gift struct with given fields in `gifts` table with transaction
