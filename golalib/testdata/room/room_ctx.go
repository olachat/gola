...
func FetchByPKCtx(ctx context.Context, val uint) *Room {
...
func FetchByPKsCtx(ctx context.Context, vals ...uint) []*Room {
...
func FindOneCtx(ctx context.Context, whereSQL string, params ...any) *Room {
...
// FetchByPK returns a row from `room` table with given primary key value
func FetchByPKFromMasterCtx(ctx context.Context, val uint) *Room {
...
// FetchByPKs returns rows with from `room` table with given primary key values
func FetchByPKsFromMasterCtx(ctx context.Context, vals ...uint) []*Room {
	pks := coredb.GetAnySlice(vals)
...
// FindOne returns a row from `room` table with arbitary where query
// whereSQL must start with "where ..."
func FindOneFromMasterCtx(ctx context.Context, whereSQL string, params ...any) *Room {
	w := coredb.NewWhere(whereSQL, params...)
