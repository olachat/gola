...
// InsertTx inserts GiftsNnWithDefault struct to `gifts_nn_with_default` table with transaction
func (c *GiftsNnWithDefault) InsertTx(ctx context.Context, tx *sql.Tx) error {
...
// UpdateTx updates GiftsNnWithDefault struct in `gifts_nn_with_default` table with transaction
func (obj *GiftsNnWithDefault) UpdateTx(ctx context.Context, tx *sql.Tx) (bool, error) {
...
// UpdateTx updates GiftsNnWithDefault struct with given fields in `gifts_nn_with_default` table with transaction
