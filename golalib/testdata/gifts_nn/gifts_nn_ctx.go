...
func FetchByPKCtx(ctx context.Context, val uint) (*GiftsNn, error) {
	return coredb.FetchByPKCtx[GiftsNn](ctx, DBName, TableName, []string{"id"}, val)
}
...
func FetchByPKsCtx(ctx context.Context, vals ...uint) ([]*GiftsNn, error) {
	pks := coredb.GetAnySlice(vals)
	return coredb.FetchByPKsCtx[GiftsNn](ctx, DBName, TableName, "id", pks)
}
...
func FindOneCtx(ctx context.Context, whereSQL string, params ...any) (*GiftsNn, error) {
	w := coredb.NewWhere(whereSQL, params...)
	return coredb.FindOneCtx[GiftsNn](ctx, DBName, TableName, w)
}
...
// whereSQL must start with "where ..."
func FindCtx(ctx context.Context, whereSQL string, params ...any) ([]*GiftsNn, error) {
	w := coredb.NewWhere(whereSQL, params...)
	return coredb.FindCtx[GiftsNn](ctx, DBName, TableName, w)
}
...
func CountCtx(ctx context.Context, whereSQL string, params ...any) (int, error) {
	return coredb.QueryIntCtx(ctx, DBName, "SELECT COUNT(*) FROM `gifts_nn` "+whereSQL, params...)
}

// FetchByPK returns a row from `gifts_nn` table with given primary key value
func FetchByPKFromMasterCtx(ctx context.Context, val uint) (*GiftsNn, error) {
	return coredb.FetchByPKFromMasterCtx[GiftsNn](ctx, DBName, TableName, []string{"id"}, val)
}
...
// FetchByPKs returns rows with from `gifts_nn` table with given primary key values
func FetchByPKsFromMasterCtx(ctx context.Context, vals ...uint) ([]*GiftsNn, error) {
	pks := coredb.GetAnySlice(vals)
	return coredb.FetchByPKsFromMasterCtx[GiftsNn](ctx, DBName, TableName, "id", pks)
}
...
// FindOne returns a row from `gifts_nn` table with arbitary where query
// whereSQL must start with "where ..."
func FindOneFromMasterCtx(ctx context.Context, whereSQL string, params ...any) (*GiftsNn, error) {
	w := coredb.NewWhere(whereSQL, params...)
	return coredb.FindOneFromMasterCtx[GiftsNn](ctx, DBName, TableName, w)
}
...
// Find returns rows from `gifts_nn` table with arbitary where query
// whereSQL must start with "where ..."
func FindFromMasterCtx(ctx context.Context, whereSQL string, params ...any) ([]*GiftsNn, error) {
	w := coredb.NewWhere(whereSQL, params...)
	return coredb.FindFromMasterCtx[GiftsNn](ctx, DBName, TableName, w)
}
...
func CountFromMasterCtx(ctx context.Context, whereSQL string, params ...any) (int, error) {
	return coredb.QueryIntFromMasterCtx(ctx, DBName, "SELECT COUNT(*) FROM `gifts_nn` "+whereSQL, params...)
}

// Insert GiftsNn struct to `gifts_nn` table
func (c *GiftsNn) InsertCtx(ctx context.Context) error {
...
func (obj *GiftsNn) UpdateCtx(ctx context.Context) (bool, error) {
