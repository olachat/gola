...
func FetchByPKCtx(ctx context.Context, val uint) *GiftsNn {
...
func FetchByPKsCtx(ctx context.Context, vals ...uint) []*GiftsNn {
...
func FindOneCtx(ctx context.Context, whereSQL string, params ...any) *GiftsNn {
...
// FetchByPK returns a row from `gifts_nn` table with given primary key value
func FetchByPKFromMasterCtx(ctx context.Context, val uint) *GiftsNn {
...
// FetchByPKs returns rows with from `gifts_nn` table with given primary key values
func FetchByPKsFromMasterCtx(ctx context.Context, vals ...uint) []*GiftsNn {
	pks := coredb.GetAnySlice(vals)
...
// FindOne returns a row from `gifts_nn` table with arbitary where query
// whereSQL must start with "where ..."
func FindOneFromMasterCtx(ctx context.Context, whereSQL string, params ...any) *GiftsNn {
	w := coredb.NewWhere(whereSQL, params...)
